...
import { CivicLogoutButton } from "@/components/CivicLogoutButton";
import { UnifiedLogoutButton } from "@/components/UnifiedLogoutButton";
...
const Index = () => {
	...
	const { isAuthenticated } = useAnyAuth();
			...
			<div className='min-h-screen bg-black relative overflow-hidden'>
				...
				<div
					...
					style={{
						...
						background:
							"radial-gradient(circle, rgba(59, 130, 246, 0.4) 0%, rgba(147, 51, 234, 0.3) 35%, rgba(236, 72, 153, 0.2) 70%, transparent 100%)",
					}}
				/>
				...
				<div className='relative z-10 flex flex-col min-h-screen'>
					...
					<header className='p-6 border-b border-gray-800/50 backdrop-blur-xl bg-black/30'>
						<div className='max-w-6xl mx-auto flex items-center justify-between'>
							...
							<div className='flex items-center space-x-4'>
								<WalletButton />
								{isAuthenticated && <UnifiedLogoutButton />}
							</div>
						</div>
					</header>
					...
					<section className='px-6 py-16 text-center'>
						<div className='max-w-4xl mx-auto'>
							<div className='relative mb-8'>
								<h2
									className='text-5xl md:text-7xl font-black mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-fade-in'
							...
							<p className='text-xl text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in'>
								Protect your Ethereum transfers with{" "}
								<Link
									to='/why-cryptosafesend'
									className='text-blue-400 font-semibold hover:text-blue-300 transition-colors underline decoration-blue-400/30 hover:decoration-blue-300/50'>
									military-grade encryption
								</Link>
									...
									<div className='relative p-8 bg-gradient-to-br from-gray-900/80 to-gray-900/40 backdrop-blur-xl rounded-3xl border border-gray-800/50 hover:border-blue-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/10 cursor-pointer h-full'>
										...
										<div className='relative'>
											...
											<p className='text-gray-400 group-hover:text-gray-300 transition-colors'>
												Each transaction is secured with a unique passcode
											</p>
										</div>
									</div>
								</Link>
								...
								<Link
									...
									<div className='relative p-8 bg-gradient-to-br from-gray-900/80 to-gray-900/40 backdrop-blur-xl rounded-3xl border border-gray-800/50 hover:border-purple-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/10 cursor-pointer h-full'>
										...
										<div className='relative'>
											...
											<p className='text-gray-400 group-hover:text-gray-300 transition-colors'>
												Powered by secure Ethereum smart contracts
											</p>
										</div>
									</div>
								</Link>
								...
								<Link
									...
									<div className='relative p-8 bg-gradient-to-br from-gray-900/80 to-gray-900/40 backdrop-blur-xl rounded-3xl border border-gray-800/50 hover:border-pink-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-pink-500/10 cursor-pointer h-full'>
										...
										<div className='relative'>
											...
											<p className='text-gray-400 group-hover:text-gray-300 transition-colors'>
												Simple interface for sending and claiming funds
											</p>
										</div>
									</div>
								</Link>
								...
								{activeTab === "messages" ? (
									<div className='flex flex-col lg:flex-row gap-6'>
										<div className='lg:w-1/3'>
											{showUsersList ? (
												<UsersList
													onSelectUser={(uid, wallet, email) =>
														handleSelectUser(uid, wallet, email)
													}
												/>
											) : (
												<>
													...
													<MessagesList
														onSelectChat={(uid, wallet, email) =>
															handleSelectChat(uid, wallet, email)
														}
													/>
												</>
											)}
												...
												<div className='flex items-center justify-center h-full min-h-[540px] bg-black/40 backdrop-blur-xl rounded-2xl border border-gray-800/50 shadow-2xl'>
													<div className='text-center text-gray-400'>
														...
														<p className='text-sm mt-2 opacity-75'>
															or start a new conversation with another user
														</p>
													</div>
												</div>
											)}
					...
					<footer className='px-6 py-12 border-t border-gray-800/50 mt-auto backdrop-blur-xl bg-black/20'>
						<div className='max-w-6xl mx-auto text-center'>
							<p className='text-gray-500 text-sm flex items-center justify-center'>
								Built with{" "}
								<span className='text-red-400 mx-1 animate-pulse'>
									💜 by SpiderStack
								</span>{" "}
								for secure Ethereum transfers.
